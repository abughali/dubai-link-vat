...
#def get_cost_and_tax(details, id_book_line):
    # Find and return the cost and tax for the given IdBookLine
#    for detail in details:
#        if detail[0] == id_book_line:
#            return detail[1], detail[2]
    
    # If IdBookLine is not found, return None
#    return None
